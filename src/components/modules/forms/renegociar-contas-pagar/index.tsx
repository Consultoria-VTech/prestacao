...
import { renegociarContasPagar } from '../../../../services/contasPagarService'
...
import { FormGroupSelect } from './../../form-group/index'
...
const FormRenegociarContasPagar: React.FC = () => {
        ...
        await renegociarContasPagar(
          ...
          .then(data => {
            alertUpdateSuccess(
              ...
              'Conta a pagar renegociada com sucesso!'
            )
...
export default FormRenegociarContasPagar
