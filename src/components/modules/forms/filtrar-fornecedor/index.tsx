...
import { FornecedorFiltro } from '../../../../types/models/fornecedor'
...
const FormFiltrarFornecedor: React.FC = () => {
  const idModal = ModalEnum.filterFornecedor
  const { closeModal, getData } = useModal<FornecedorFiltro>(idModal)
  ...
  const {
    ...
    onSubmit: async (values: FornecedorFiltro) => {
      try {
        setSubmitting(true)
...
export default FormFiltrarFornecedor
