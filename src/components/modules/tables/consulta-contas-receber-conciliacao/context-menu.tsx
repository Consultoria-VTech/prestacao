...
const ContextMenuEstornarContasReceber = <T extends object = any>({
  onItemClick,
  ...
  const { show } = useContextMenu({
    id: ContextMenuEnum.menuEstornarContasReceber,
  })
    ...
    async ({ event, props }) => {
      try {
        ...
        switch (action) {
          ...
          //   break
          case 'Estornar':
            openModal(ModalEnum.estornarContasReceber, contaReceber, {
              action: 'update',
            })
            break
          case 'baixar':
  ...
  return {
    idContextMenu: ContextMenuEnum.menuEstornarContasReceber,
    items: contextMenuItems,
    displayMenu,
  }
}

export default ContextMenuEstornarContasReceber
