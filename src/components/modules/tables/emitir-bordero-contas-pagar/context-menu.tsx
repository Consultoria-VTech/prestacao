...
const ContextMenuEmitirBordero = <T extends object = any>({
  onItemClick,
  ...
  const { show } = useContextMenu({
    id: ContextMenuEnum.menuEmitirBorderoContasPagar,
  })
    ...
    async ({ event, props }) => {
      try {
        ...
        switch (action) {
          ...
          //   break
          case 'bordero':
            openModal(ModalEnum.emitirBorderoContasPagar, contaPagar, {
              action: 'update',
            })
            break
          case 'baixar':
  ...
  return {
    idContextMenu: ContextMenuEnum.menuEmitirBorderoContasPagar,
    items: contextMenuItems,
    displayMenu,
  }
}

export default ContextMenuEmitirBordero
