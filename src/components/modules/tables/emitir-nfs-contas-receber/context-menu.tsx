...
const ContextMenuEmitirNFSContasReceber = <T extends object = any>({
  onItemClick,
  ...
  const { show } = useContextMenu({
    id: ContextMenuEnum.menuEmitirNFSContasReceber,
  })
    ...
    async ({ event, props }) => {
      try {
        ...
        switch (action) {
          ...
          //   break
          case 'Emitir':
            openModal(ModalEnum.emitirNFSContasReceber, contaReceber, {
              action: 'update',
            })
            break
          // case 'baixar':
  ...
  return {
    idContextMenu: ContextMenuEnum.menuEmitirNFSContasReceber,
    items: contextMenuItems,
    displayMenu,
  }
}

export default ContextMenuEmitirNFSContasReceber
