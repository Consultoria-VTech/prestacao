...
const ControladoriaPageDreComparativoTrimestral: NextPage<PageProps> = () => {
  ...
  return (
    <SystemLayout >
      ...
      <iframe width="100%" height="700" src="https://app.powerbi.com/reportEmbed?reportId=f7330483-0f5d-46df-b625-9bbeafec99eb&autoAuth=true&ctid=963028bf-5d91-4069-868e-f512e5993a1c&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLWJyYXppbC1zb3V0aC1yZWRpcmVjdC5hbmFseXNpcy53aW5kb3dzLm5ldC8ifQ%3D%3D"></iframe>
      </TemplateDefault>
    </SystemLayout>
  )
...
export default ControladoriaPageDreComparativoTrimestral
