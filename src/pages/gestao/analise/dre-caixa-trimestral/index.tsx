...
const ControladoriaPageDreCaixaTrimestral: NextPage<PageProps> = () => {
  ...
  return (
    <SystemLayout>
      ...
      <iframe width="100%" height="700" src="https://app.powerbi.com/reportEmbed?reportId=4e39b1ae-318f-40c5-be1a-3e53a9e1663a&autoAuth=true&ctid=963028bf-5d91-4069-868e-f512e5993a1c&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLWJyYXppbC1zb3V0aC1yZWRpcmVjdC5hbmFseXNpcy53aW5kb3dzLm5ldC8ifQ%3D%3D"></iframe>
      </TemplateDefault>
    </SystemLayout>
  )
...
export default ControladoriaPageDreCaixaTrimestral
