...
const ControladoriaPage: NextPage<PageProps> = () => {
  ...
  return (
    <SystemLayout>
      ...
      <iframe width="100%" height="700" src="https://app.powerbi.com/reportEmbed?reportId=43ab3eb3-d6e4-4005-a046-26ed21b35ab2&autoAuth=true&ctid=963028bf-5d91-4069-868e-f512e5993a1c&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLWJyYXppbC1zb3V0aC1yZWRpcmVjdC5hbmFseXNpcy53aW5kb3dzLm5ldC8ifQ%3D%3D"></iframe>
      </TemplateDefault>
    </SystemLayout>
  )
