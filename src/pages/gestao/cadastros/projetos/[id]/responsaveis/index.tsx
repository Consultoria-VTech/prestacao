import { ProjetoResponsavelTemplate } from '@components'
import { PageProps, ProjetoResponsavelPagination } from '@types'
...
type ProjetoResponsavelPageProps = PageProps<ProjetoResponsavelPagination>
const ProjetosResponsaveisPage: NextPage<ProjetoResponsavelPageProps> =
  props => {
    ...
    return (
      <SystemLayout title={page?.name}>
        <TemplateDefault page={page}>
          <ProjetoResponsavelTemplate data={props?.data} />
        </TemplateDefault>
      </SystemLayout>
    )
  }
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    ...
    const response = await axios.get(URL_API + '/api/projetoresponsavel', {
