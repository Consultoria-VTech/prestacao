...
import FornecedorTemplate from '../../../../components/templates/fornecedor'
...
type FornecedorPageProps = PageProps<FornecedorPagination>

const FornecedoresPage: NextPage<FornecedorPageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <FornecedorTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    const { size, page, idEmpresa, id, nome, cnpj, ativo } = context.query

    const response = await axios.get(URL_API + '/api/fornecedores', {
