...
import ContasReceberTemplate from '../../../../components/templates/contas-receber/index'
...
type ContasReceberPageProps = PageProps<ContasReceberPagination>

const ContasReceberPage: NextPage<ContasReceberPageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <ContasReceberTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
