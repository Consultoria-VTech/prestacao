...
import ImpostoTemplate from '../../../../components/templates/imposto'
...
type ImpostoPageProps = PageProps<ImpostoPagination>

const ImpostosPage: NextPage<ImpostoPageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <ImpostoTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    ...
    const response = await axios.get(URL_API + '/api/impostos', {
