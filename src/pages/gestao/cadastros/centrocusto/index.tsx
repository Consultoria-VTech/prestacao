...
import CentroCustoTemplate from '../../../../components/templates/centro-custo'
...
type CentroCustoPageProps = PageProps<CentroCustoPagination>

const CentroCustoPage: NextPage<CentroCustoPageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <CentroCustoTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    const { size, page, idEmpresa, id, nome, ativo } = context.query

    const response = await axios.get(URL_API + '/api/centrocusto', {
