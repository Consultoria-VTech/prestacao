...
import ContasPagarTemplate from '../../../../components/templates/contas-pagar/index'
...
type ContasPagarPageProps = PageProps<ContasPagarPagination>

const ContasPagarPage: NextPage<ContasPagarPageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <ContasPagarTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
