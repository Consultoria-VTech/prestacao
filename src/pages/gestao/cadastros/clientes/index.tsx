...
import ClienteTemplate from '../../../../components/templates/cliente'
...
type ClientePageProps = PageProps<ClientePagination>

const ClientesPage: NextPage<ClientePageProps> = props => {
  ...
  return (
    <SystemLayout title={page.name}>
      <TemplateDefault page={page}>
        <ClienteTemplate data={props?.data} />
      </TemplateDefault>
    </SystemLayout>
  )
}
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    const { size, page, idEmpresa, id, nome, cnpj, filial, ativo } =
      context.query
