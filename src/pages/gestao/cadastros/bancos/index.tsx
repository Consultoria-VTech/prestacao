...
import { BancoTemplate } from '@components'
...
type BancoPageProps = PageProps<BancoPagination>

const BancosPage: NextPage<BancoPageProps> = props => {
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  try {
    ...
    const response = await axios.get(URL_API + '/api/banks', {
